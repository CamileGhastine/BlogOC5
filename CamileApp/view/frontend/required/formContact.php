...
if(!empty($result)) : ?>
    <div class="my-5 alert alert-<?= ($result === 'ok') ? 'success' : 'danger' ?>">
        <div class="row">
            <div class="col-lg-12 text-center">
                <?= ($result === 'ok') ? 'Le formulaire de contact a été envoyé avec succès.' : 'Une erreur est survenue et le formualire n\'a pas pu être envoyé.' ?>
            </div>
            <div class="col-lg-12 text-center mt-3">
                <a href="index.php" class="btn btn-success" id="btn-perso1">Retour à l'accueil</a>
            </div>
        </div>
    </div>
<?php else : ?>
