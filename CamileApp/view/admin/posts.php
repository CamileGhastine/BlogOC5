...
<div class="row">
    <div class="col-lg-4">
        <p><a href="index.php?route=admin.addPost" class="btn btn-success mt-3">Ajouter un artcile</a></p>
    </div>
    <div class="col-lg-8">
            ...
            <tr>
                ...
                <td>
                    <?php if($btn == 'secondary'): ?>
                        <a id="deleteConfirmation" href="index.php?route=admin.deletePost&id=<?= $postId ?>" class="btn-sm btn-primary mt-3">Confirmer</a>
